<template>
	<view class="container">
		...
		<view class="owner_phone" style="font-size: 30upx; background-color: #ffffff; margin-top: 20upx; padding: 20upx;">
			请输入业主手机号后四位: <text style="font-size: 20upx;">如不知业主手机号,请联系业主</text>
			<view style="font-size: 50upx; display: flex; align-items: center; justify-content: center; padding: 40upx;" >
				{{beforePhone}} &nbsp;<u-code-input v-model="value" mode="line" maxlength="4" hairline size="50" fontSize="50" color="black" space="20" @finish="finish"></u-code-input>
			</view>
		</view>
		...
		<u-form :mode="formData">
			<u-from-item>
				...
				<template #suffix>
					<view class="my_radio">
						<view class="male" @click="identity = true" :class="identity == true ? 'checked' : '' ">
							家属
						</view>
						<view class="female" @click="identity = false " :class="identity == false ? 'checked' : ''">
							租户
						</view>
					</view>
				</template>
			...
			<u-from-item>
				...
				<template #suffix>
					<view class="my_radio">
						<view class="male" @click="gender = true" :class="gender == true ? 'checked' : '' ">
							男
						</view>
						<view class="female" @click="gender = false " :class="gender == false ? 'checked' : ''">
							女
						</view>
					</view>
				</template>
			...
			<u-form-item>
				...
				<u-row justify="center" style="margin-top: 50upx;">
					<u-col span="8">
						<u-button type="primary" shape="circle" @click="submit" :disabled="disabled"><text style="color: #ffffff;" >提交审核</text></u-button>
					</u-col>
				</u-row>
...
<script>
	import {HouseList,AddHouse,getOwnerPhone} from '@/api/home.js'
...
.my_radio{
	...
	width:fit-content;	height:70upx;
	.male,.female{
		width:100upx;
